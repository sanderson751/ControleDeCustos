...
- RNF-05: O controle de acesso deve ser implementado no frontend com validação de segurança no backend (futuro).
...
- RB-04: Apenas Admin pode acessar e modificar o menu "Perfil de Usuários".
