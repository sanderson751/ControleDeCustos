...
- RNF-04: Interface de autenticacao deve manter legibilidade em `light` e `dark` com contraste minimo AA.
- RNF-05: Operacoes com erro/sucesso/warning devem exibir snackbar no canto superior direito.
- RNF-06: Snackbar deve ter exibicao automatica de 3 segundos e acao de fechar com icone `X`.
- RNF-07: Cores do snackbar por status: vermelho (erro), verde (sucesso), amarelo (warning).
